...
to working with CS2 when compared to CS:GO, first of all being that the process is now 64-bit which means addresses will be 8-byte addressable. Additionally structs within the game's memory have altered, and getting
